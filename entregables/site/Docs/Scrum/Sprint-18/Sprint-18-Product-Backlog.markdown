...
* (?) Error al pegar texto en una nota de postulante (parece que lo agarra el upload, detectará drag&drop?).
* (?) Agregar popover con skills técnicos de un empleado y postulante.
* (?) Además de la empresa, deberían agregarse más detalles como puesto de trabajo o notas en experiencias anteriores de los applicants.
* (?) El campo de nivel de inglés podría separarse en tres (o eliminarse y utilizar technicall skills).
* (1) Permitir extender el tamaño del textarea de las notas.
* (10) Análisis Mejorar performance página de ausencias.
* (5) Mostrar entrevistas en Postulantes sugeridos.
